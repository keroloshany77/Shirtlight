      ...
      <AnimatePresence>
        {viewUser && (
          <>
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95, y: 20 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.95, y: 20 }} className="admin-floating-modal w-full max-w-md bg-[#0a0a0a] border border-white/10 rounded-xl p-6 z-[2001] shadow-2xl">
